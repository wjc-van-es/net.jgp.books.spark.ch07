...
public class ComplexCsvToDataframeApp {
    ...
    private void start() {
        ...
        Dataset<Row> df = spark.read().format("csv")
                ...
                .option("sep", ";") // primary field separator character
                .option("quote", "*") //Indicating a second field separator to escape any primary separator characters inside
                .option("dateFormat", "MM/dd/yyyy")
                .option("inferSchema", true) //try to infer the schema
                .load("data/books.csv");
