...
public class JsonLinesToDataframeWithLinearizationApp {
    ...
    private void start() {
        ...
        // adding extra fields from the hierarchical structure as means to arrive at a flat dataframe structure
        // in an exhaustive treatment the old hierarchical structured columns can all be discarded
        // (after their role as source for the flat extra columns is played out)
